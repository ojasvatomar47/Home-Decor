...
interface Product {
  ...
  image: string;
  description: string;
  href?: string; // Make href optional if it's not always used for navigation
}
...
export default function ProductsPage() {
  ...
  const products: Product[] = [ // Fixed: Unexpected any
    ...
    { name: 'Sofa Cover', image: '/images/sofa-cover.jpg', description: 'Protect and refresh your sofa&apos;s look with our durable and fashionable sofa covers, available in various patterns and fabrics. An easy way to update your living room decor and extend the life of your furniture.' }, // Fixed: '
    ...
    { name: 'Dining Table', image: '/images/dining-table.jpg', description: 'Create memorable dining experiences with our elegant dining tables and coordinating covers, designed for every home. Choose from various sizes and materials to suit your family&apos;s needs and dining space.' }, // Fixed: '
    ...
    { name: 'Mattress', image: '/images/mattress.jpg', description: 'Invest in restful sleep with our range of comfortable and supportive mattresses, designed for ultimate relaxation. Explore options from memory foam to orthopedic, ensuring a perfect night&apos;s rest.' }, // Fixed: '
